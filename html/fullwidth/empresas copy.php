...
<div class="container">
    ...
    <div class="one_half"><img src="images/empresas.png" alt="" class="img_left"></div><!-- end left image -->
    
    <div class="one_half last">
    
    	<h2 class="section_title_drakgray bline"><strong>Empresas </strong></h2>
        
    	<ul class="active">
        	<li class="icon"><i class="fa fa-building"></i></li>
            <li class="text"><h3 class="nocaps">Sabemos que...</h3> <p> Una de las preocupaciones en las empresas son las adicciones y sus consecuencias en el ambiente laboral. Por ello contamos con el Programa para Empresas. Si necesita más información, llámenos.</p></li>
        </ul>
